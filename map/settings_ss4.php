...
<div class="page-content">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h6 class="panel-title">Sample Sorting 4 Customize</h6>

            <div class="btn-group pull-right">
                <form action="scripts/exporttemp.php" method="post">


                    <a href="settings_ss4temp.php" <button class="btn btn-success"><i class="fa fa-cog"></i>Customize
                ...
                <div class="tab-content has-padding">
                    ...
                    <div class="tab-pane active fade in" id="tabone">
                        ...
                        if(isset($_SESSION['expcode'])){
                         ...
                         array_push($fields_array, "Form row (FR)", "Health Centres (HC)","Water Body Name (WN)","Water Level (WL)","Depth (DE)","Flow Rate (RET)","Water Body Type (WT)","Longevity of Water Body Type (LWT)","Snail Present (SP)","Snail Species Collected (SPC)","Number Collected (N)","Snail Species Shedded (SPS)","Type of Cercaria (TC)","Number Cercaria Shedded (NC)");
                         
               
                         $disabled_fields_array = array("Serial No. (SEN)","ED Form Serial Number (SSEN)","ED Form row (SFR)");
                         array_push($disabled_fields_array,"Form row (FR)","Number Collected (N)","Snail Present (SP)","Snail Species Collected (SPC)","Water Body Name (WN)","Water Body Type (WT)","Longevity of Water Body Type (LWT)","Depth (DE)","Flow Rate (RET)","Snail Present (SP)","Snail Spiecies Collected (SPC)","Water Level (WL)");

                          
                         //definition
                         $fields_array_two = array("Serial No. (SEN)","ED Form Serial Number (SSEN)","ED Form row (SFR)");
                         array_push($fields_array_two, "Form row (FR)","Health Centres (HC)","Water Body Name (WN)","Water Level (WL)","Depth (DE)","Flow Rate (RET)","Water Body Type (WT)","Longevity of Water Body Type (LWT)","Snail Present (SP)","Snail Species Collected (SPC)","Number Collected (N)","Snail Species Shedded (SPS)","Type of Cercaria (TC)","Number Cercaria Shedded (NC)");
