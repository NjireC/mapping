                  ...
                  if ($result == TRUE) {
                     ...
                     if ($pnum_row == 1) {
                        ...
                        if ($projectregsite > 0) {
                                 ...
                                 elseif ($rowtype == 3/* && $pass ==1*/) {
                                    ...
                                    if ($resulttype == 2) {
                                       ...
                                       if (is_int($data)) {
                                          ...
                                          //prepare query to insert into SS3

                                          $query_part = "INSERT INTO $ss3 (edssid,$patternattribute,senfr,userid,submitted) VALUES($edssid,$line_array,$senfr,$staff_id,'$submitted')";
                           ...
                           $query_insert_edss = "INSERT INTO  $ssso (ss3id) SELECT `ss3`.`id` FROM
                                  $ssso as ssso RIGHT JOIN  $ss3 as ss3 ON (`ssso`.`ss3id` = `ss3`.`id`) WHERE ssso.ss3id IS NULL";
