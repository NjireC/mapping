...
$field2 = "ft";
  ...
  if($db->num_rows($resultcust) === 0){
        ...
        $sql .= " WHERE ".$db->escape($field)."=".$_SESSION['expcode']." AND ".$db->escape($field2)."="."'ST2'";
        $sql .= " LIMIT 1";
            ...
            <div class="tabbable page-tabs">
                ...
                <div class="tab-content has-padding">
                    ...
                    <div class="tab-pane active fade in" id="tabone">
                        ...
                        $fields_array = array("Serial No. (SEN)","Formrow (FR)","Box & Form Serial Number (SSEN)","No. of Samples (NS)");
                        array_push($fields_array, "Storage Temperature (FST)", "Crate/Freezer/Fridge Number (FF)","Rack/Carton Number (RCN)");
                      
                        $disabled_fields_array = array("Serial No. (SEN)","Formrow (FR)","Box & Form Serial Number (SSEN)");
      
                        //definition
                        $fields_array_two = array("Unique identifier for each form","Unique identifier of each row on the data collection form","Unique identifier for the source data collection form","The number of samples stored in the 81 cell sample storage box");
                        array_push($fields_array_two, "Designates the temperature at which the samples will be stored under ", "Designates the unique identifier of the crate, fridge or freezer where the samples are stored","Designates the unique identifier of the rack or carton where the samples are stored inside of the crate, fridge or freezer");
                    ...
                    <div class="tab-pane fade" id="tabtwo">
                        <div class="animate__animated animate__fadeIn">
                            <img src="assets/images/ST2_form.png" alt="">
                        </div>
                    </div>
                    <!-- /second tab -->
