...
<div class="page-content">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h6 class="panel-title">Sample Sorting 2 Customize</h6>
            <div class="btn-group pull-right">
                <form action="scripts/exporttemp.php" method="post">

                    <a href="settings_ss2temp.php" <button class="btn btn-success"><i class="fa fa-cog"></i>Customize
                ...
                <div class="tab-content has-padding">
                    ...
                    <div class="tab-pane active fade in" id="tabone">
                        ...
                        if(isset($_SESSION['expcode'])){
                         ...
                         $fields_array = array("Serial No. (SEN)","ED Form Serial Number (SSEN)","ED Form row (SFR)","Form row (FR)","Habitat ID (HF)","Habitat type (HBT)","Habitat treated (HTR)","Habitat Wet (HW)","Habitat Size (HS)","Distance to next house (DNH)","Vegetation (VL)","Rice length (RL)","Treated(VT)");
                         ...
                         //definition
                         $fields_array_two = array("Serial No. (SEN)","ED Form Serial Number (SSEN)","ED Form row (SFR)","Form row (FR)","Habitat ID (HF)","Habitat type (HBT)","Habitat treated (HTR)","Habitat Wet (HW)","Habitat Size (HS)","Distance to next house (DNH)","Vegetation (VL)","Rice length (RL)","Treated(VT)");
                         array_push($fields_array_two,"Dipping effort (DIP)","Taxon (TX)","bfEgg (bfEgg)","Larval stage_L1 (bfL1)","Larval stage_L2 (bfL2)","Larval stage_L3 (bfL3)","Larval stage_L4 (bfL4)","Larval stage_L1L2 (L1L2)","Larval stage_L3L4 (L3L4)","Total larvae (TLV)","Pupae(PU)");
                         
                         // array_push($fields_array,"Number Sampled Dipping 1 (NDI01)","Number Sampled Dipping 2 (NDI02)","Number Sampled Dipping 3 (NDI03)","Number Sampled Dipping 4 (NDI04)","Number Sampled Dipping 5 (NDI05)");
 
                         // array_push($fields_array,"Number Sampled Dipping 6 (NDI06)","Number Sampled Dipping 7 (NDI07)","Number Sampled Dipping 8 (NDI08)","Number Sampled Dipping 9 (NDI09)","Number Sampled Dipping 10 (NDI10)");
 
                         array_push($fields_array_two,"Notes (Notes)","Sample Label Code (SLC)","No. of Individual (NI)","No. of Batches (NB)");
                         array_push($fields_array_two,"No. In Batch 1 (SID01)", "No. In Batch 2 (SID02)","No. In Batch 3 (SID03)","No. In Batch 4 (SID04)");
                         array_push($fields_array_two,"No. In Batch 5 (SID05)", "No. In Batch 6 (SID06)","No. In Batch 7 (SID07)","No. Discarded (NOD)");
                    ...
                    <div class="tab-pane fade" id="tabtwo">
                        <div class="animate__animated animate__fadeIn">
                            <img src="assets/images/SS2_form.png" alt="">
                        </div>
                    </div>
                    <!-- /second tab -->
