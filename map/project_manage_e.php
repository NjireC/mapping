...
$all_names = find_all('staff');
 ...
 <div class="page-content">
 	...
 	<!-- /page title -->
                ...
                <!-- Form -->
            <form class="form-horizontal" action="scripts/updateproject.php" role="form"  method="post">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class=" form-control"  name="pn" id="pn"  value="<?php echo $e_project['pn']; ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class=" datepicker form-control datformat" name="esd" id="esd" value="<?php echo $e_project['esd']; ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="datepicker  form-control datformat" name="efd" id="efd"  value="<?php echo $e_project['efd']; ?>" required>
                            </div>
                        </div>
                        ...
                        <!--<div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class=" form-control" name="eap" id="eap" value="<?php echo $e_project['eap']; ?>" required>
                            </div>
                        </div> -->
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select  class="select-full select-disabled" name="rsn" id="rsn">   
                                   <option value=""> Select Name</option>
                                    
                                         <?php  foreach ($all_names as $name): 

                                            if ($e_project['rsn'] === $name['staff_id']) { 
                                                $selected = ' selected'; 
                                            }else{
                                                $selected = ' '; 
                                            } 

                                            echo '<option value="'.$name['staff_id'].'"'. $selected .'>' .$name['fname']." ".$name['lname'].'</option>';  
                       ...
                       <!--  <div class="form-group">
                        ...
                        <div class="form-actions text-right">
                            <button name="updateproj" type="submit" id="addproj" class="btn btn-primary"  > <i class="fa fa-check" aria-hidden="true"></i>Update</button>
                        </div>
