                                 ...
                                 elseif ($rowtype == 3/* && $pass ==1*/) {
                                    ...
                                    if ($resulttype == 2) {
                                       ...
                                       if (is_int($data)) {
                                          ...
                                          $query_part = "INSERT INTO $so1 (sssoid,$patternattribute,userid,submitted) VALUES($sssoid,$line_array,$staff_id,'$submitted')";

                                          echo 'Done:SEN:' . $arraycsvss[0] . ',SSEN:' . $arraycsvss[1] . ',SFR:' . $arraycsvss[2] . "<br />";
                                          //execute query
