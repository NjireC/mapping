...
$field2 = "ft";
  ...
  if($db->num_rows($resultcust) === 0){
        ...
        $sql .= " WHERE ".$db->escape($field)."=".$_SESSION['expcode']." AND ".$db->escape($field2)."="."'SO1'";
        $sql .= " LIMIT 1";
...
<div class="page-content">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h6 class="panel-title">Sample Observation</h6>
            ...
            <div class="tabbable page-tabs">
                ...
                <div class="tab-content has-padding">
                    ...
                    <div class="tab-pane active fade in" id="tabone">
                        ...
                        array_push($fields_array, "Source Sample ID (SSID)", "Taxon (STX)","PCR Species (Species)","PCR KDR (kdr)");
                        array_push($fields_array, "CSP ELISA Pf (pf)", "CSP ELISA Pv (pv)","CSP ELISA Po (po)","CSP ELISA Pm (pm)");
                        array_push($fields_array, "Bloodmeal ELISA Human (human)", "Bloodmeal ELISA Chicken (chicken)","Bloodmeal ELISA Goat (goat)","Bloodmeal ELISA Bovine (bovine)");
                        array_push($fields_array, "Bloodmeal ELISA Dog (dog)", "Bloodmeal ELISA Cat (cat)","Bloodmeal ELISA Rat (rat)","Body Part Stored (BPS)");
                      

                        $disabled_fields_array = array("Serial No. (SEN)","Formrow (FR)","Box Row Column (RC)","SS Form Serial Number (SSEN)","SS Form row (SFR)");
                        //array_push($disabled_fields_array,"Source Sample Label Code (SSLC)", "Sample Type (SST)","Sample ID (SSID)", "Taxon (STX)","Body Part Stored (BPS)");
 ...
 either individual or batch or pool");
                        array_push($fields_array_two, "Unique identifier of each sample within one sample type from the source form", "Taxonomic classification of the mosquitoes within the collection","Polymerase chain reaction results to identify which sibling species within a group (e.g., An. funestus) or complex (e.g., An. gambiae) the individual mosquito is from","Polymerase chain reaction results to identify molecular detection of the presence of the pyrethroid knockdown resistance gene");
                        array_push($fields_array_two, "Circumsporozoite (CSP) protein enzyme-linked immunosorbent assay (ELISA)  results to detect the molecular presence of Plasmodium sp. (P. falciparum)", "Circumsporozoite (CSP) protein enzyme-linked immunosorbent assay (ELISA)  results to detect the molecular presence of Plasmodium sp. (P. vivax)","Circumsporozoite (CSP) protein enzyme-linked immunosorbent assay (ELISA)  results to detect the molecular presence of Plasmodium sp. (P.ovale)","Circumsporozoite (CSP) protein enzyme-linked immunosorbent assay (ELISA)  results to detect the molecular presence of Plasmodium sp. (P. malariae)");
                        array_push($fields_array_two, "Enzyme-linked immunosorbent assay (ELISA) results to identify presence of specific host species or other taxa in the blood of mosquito sample - Human (human)", "Enzyme-linked immunosorbent assay (ELISA) results to identify presence of specific host species or other taxa in the blood of mosquito sample - Chicken (chicken)","Enzyme-linked immunosorbent assay (ELISA) results to identify presence of specific host species or other taxa in the blood of mosquito sample - Goat (goat)","Enzyme-linked immunosorbent assay (ELISA) results to identify presence of specific host species or other taxa in the blood of mosquito sample - Bovine (bovine)");
                        array_push($fields_array_two, "Enzyme-linked immunosorbent assay (ELISA) results to identify presence of specific host species or other taxa in the blood of mosquito sample Dog (dog)", "Enzyme-linked immunosorbent assay (ELISA) results to identify presence of specific host species or other taxa in the blood of mosquito sample - Cat (cat)","Enzyme-linked immunosorbent assay (ELISA) results to identify presence of specific host species or other taxa in the blood of mosquito sample - Rat (rat)","Describe the mosquito body part that is store after analysis ");
                    ...
                    <div class="tab-pane fade" id="tabtwo">
                        <div class="animate__animated animate__fadeIn">
                            <img src="assets/images/SO1_form.png" alt="">
                        </div>
                    </div>
                    <!-- /second tab -->
