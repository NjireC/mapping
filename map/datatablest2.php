...
<div class="page-content">
    ...
    <div class="panel panel-default">
        ...
        <div class="table-responsive has-padding2">
            ...
            <table id="tabledata" class="table animate__animated animate__slideInUp" data-url="scripts/table/st2.php" data-toolbar="#toolbar" data-page-size="15" data-page-list="[100,500,1000,2000,5000,8000,10000,All]" data-export-options='{"fileName": "ED1-<?php echo date('Y-m-d'); ?>"}'>
