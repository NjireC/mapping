...
$temptypetr = "tr";
$tabletr = $prefixtable."treatment_two";

$temptypecc = "cc";
$tablecc = $prefixtable."colonycode";


$temptypeed1temp = "ed2template";
$tableed1temp = $prefixtable."ed2template";
 	...
 	<div class="row">  <!-- Begin row 2   -->
 		<div class="col-md-6">
 			...
 			<div class="panel panel-default">
 				<div class="panel-heading">
 					<h6 class="panel-title">Colony code</h6>
					...
					<div class="btn-group pull-right">
		             <form action="scripts/exporttemplate.php" method="post">
		              ...
		              <input type="hidden" name="te" value="<?php echo $temptypecc; ?>" >  
		              <input type="hidden" name="ta" value="<?php echo $tablecc; ?>" >  
 						...
 						<div class="row">
 							<form action="scripts/importtemplate.php" method="post" enctype="multipart/form-data" id="importFrm">
 								...
 								<div class="col-md-6 text-right">
 								 ...
 								 <input type="hidden" name="fo" value="<?php echo $temptypecc; ?>" >  
                                 <input type="hidden" name="ta" value="<?php echo $tablecc; ?>" > 
                            ...
                            <table 
					          ...
					          <thead>
				                ...
				                <?php
				                    ...
				                    $query = $db->query("SELECT * FROM {$db->escape($tablecc)} ORDER BY id ASC");
				                    if($query->num_rows > 0){ 
				                        while($row = $query->fetch_assoc()){ ?>
				                    <tr>
				                      <td><?php echo $row['number']; ?></td>
				                      <td><?php echo $row[$temptypecc]; ?></td>
