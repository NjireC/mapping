...
$temptypess1temp = "ss1template";
$tabless1temp = $prefixtable."ss1template";
 						...
 						<div class="row">
 							<form action="scripts/importtemplate.php" method="post" enctype="multipart/form-data" id="importFrm">
 								...
 								<div class="col-md-6 text-right">
 								 ...
 								 <input type="hidden" name="fo" value="<?php echo $temptypetx; ?>" >  
                                 <input type="hidden" name="ta" value="<?php echo $tabletx; ?>" > 
 						...
 						<div class="row">
 							<form action="scripts/importtemplate.php" method="post" enctype="multipart/form-data" id="importFrm">
 								...
 								<div class="col-md-6 text-right">
 								 ...
 								 <input type="hidden" name="fo" value="<?php echo $temptypesas; ?>" >  
                                 <input type="hidden" name="ta" value="<?php echo $tablesas; ?>" > 
                           ...
                           <table 
					          ...
					          <thead>
				                ...
				                <?php
				                    ...
				                    <tr>
				                      <td><?php echo $row['number']; ?></td>
				                      <td><?php echo $row[$temptypesas]; ?></td>
