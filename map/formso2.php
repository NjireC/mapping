...
$page_title = 'Sample Observation | MosquitoDB';
            ...
            <div id="body_n">
               ...
               function insertdata($projectid, $siteid, $staff_id, $submitted)
               {
                  ...
                  if ($result == TRUE) {
                     ...
                     $pquery = "SELECT * FROM $table  WHERE custso.pc='$projectid' AND  custso.ft='$formtype'";
                     //execute query
                     ...
                     if ($pnum_row == 1) {
                        ...
                        if ($projectregsite > 0) {
                           ...
                           if (count($arraycsv1) == count($arraypattern)) {
                                 ...
                                 elseif ($rowtype == 3/* && $pass ==1*/) {
                                    ...
                                    if ($resulttype == 2) {
                                       ...
                                       if (is_int($data)) {
                                          ...
                                          $query_part = "INSERT INTO $so1 (sssoid,$patternattribute,userid,submitted) VALUES($edssid,$line_array,$staff_id,'$submitted')";
                                          ...
                                          if ($result == TRUE) {
                                             ...
                                             if ($db->mysqlierrorno() === 1062) {
                                                $error = 'Dublicate Record:SSEN:' . $arraycsvss[1] . ',SFR:' . $arraycsvss[2];
                                             } else {
                              ...
                              $query_insert_edss = "INSERT INTO  $ssso (ss1id) SELECT `ss1`.`id` FROM
                                      $ssso as ssso RIGHT JOIN  $ss1 as ss1 ON (`ssso`.`ss1id` = `ss1`.`id`) WHERE ssso.ss1id IS NULL
                                      ";
