            ...
            <div class="tabbable page-tabs">
                ...
                <div class="tab-content has-padding">
                    ...
                    <div class="tab-pane active fade in" id="tabone">
                        ...
                        //definition
                        $fields_array_two = array("Unique identifier for each form","Unique identifier for the source data collection form","Unique identifier for the row of the source data collection form ","Unique identifier of each row on the data collection form");
                        ...
                        array_push($fields_array_two, "Unique identifier of each sample within one sample type from the source form", "Taxonomic classification of the mosquitoes within the collection ","The sex of the mosquitoes or if female, the visual classification of abdomen");
                        array_push($fields_array_two, "Determination of the mating status of the mosquito by the presence or absence of the mating plug and sperm in the spermathecae", "Morphological identification of the nulliparous from parous using ovarian tracheation and classification of ovary development according to Christophers stages","Infection: Occysts","Determination if the mosquito has recently laid eggs by the presence or absence of egg sacs attached to the ovariolar stalks");
                        array_push($fields_array_two, "Measurement of the length of mosquito wings","Describe the mosquito body part that is store after analysis");
                    ...
                    <div class="tab-pane fade" id="tabtwo">
                        <div class="animate__animated animate__fadeIn">
                            <img src="assets/images/SO2_form.png" alt="">
                        </div>
                    </div>
                    <!-- /second tab -->
